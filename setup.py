...
setup(
  ...
  description='Utilities for simulation towards CHEP',
  ...
  #url='https://github.com/benedikt-voelkel/DetSimAna',
  ...
  install_requires=[ "matplotlib", "seaborn", "pylint", "pyyaml"],
  ...
  package_data={ "chep_utils.data": [ "run_config.yaml" ] },
  ...
  entry_points={
      "console_scripts": [ "sim-analysis = chep_utils.analysis:main" ]
  }
)
